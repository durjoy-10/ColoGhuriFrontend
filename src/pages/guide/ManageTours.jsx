                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="rounded-3xl border border-primary-100 bg-primary-50/60 p-5">
                        ...
                        <p className="mt-1 text-sm text-slate-600">
                            Add clear tour information so travellers can easily understand and book your package.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            required
                            placeholder="Example: Cox's Bazar Weekend Tour"
                            className="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 shadow-sm outline-none transition focus:border-primary-500 focus:ring-4 focus:ring-primary-100"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            required
                            rows="5"
                            placeholder="Describe the tour details, attractions, travel experience, services, and important notes..."
                            className="w-full resize-none rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 shadow-sm outline-none transition placeholder:text-slate-400 focus:border-primary-500 focus:ring-4 focus:ring-primary-100"
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div>
                            <label className="mb-2 block text-sm font-semibold text-slate-800">
                                Price per Person (BDT) <span className="text-red-500">*</span>
                            </label>
                            <input
                                type="number"
                    ...
                    <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 shadow-sm outline-none transition focus:border-primary-500 focus:ring-4 focus:ring-primary-100 disabled:bg-slate-100 disabled:text-slate-500"
                            >
                                {TOUR_STATUS.map((s) => (
                            ...
                            {editingTour?.is_locked && (
                                <p className="mt-2 text-xs font-medium text-red-500">
                                    Completed tours cannot be edited.
                                </p>
                            )}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="rounded-3xl border-2 border-dashed border-slate-300 bg-slate-50 p-5 transition hover:border-primary-400 hover:bg-primary-50/40">
                            <input
                                type="file"
                                name="cover_image"
                                accept="image/*"
                                onChange={handleChange}
                                disabled={editingTour?.is_locked}
                                className="block w-full cursor-pointer rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-700 file:mr-4 file:rounded-xl file:border-0 file:bg-primary-600 file:px-4 file:py-2 file:text-sm file:font-semibold file:text-white hover:file:bg-primary-700 disabled:cursor-not-allowed disabled:bg-slate-100"
                            />
            
                            <p className="mt-2 text-xs text-slate-500">
                                Recommended: 800×600 px. Maximum file size: 5 MB.
                            </p>
                            ...
                            {previewUrl && (
                                <div className="mt-4">
                                    ...
                                    <div className="relative h-40 w-56 overflow-hidden rounded-2xl border border-slate-200 shadow-soft">
                                        <img
                                            src={previewUrl}
                                            alt="Preview"
                    ...
                    <div className="flex flex-col-reverse gap-3 border-t border-slate-200 pt-5 sm:flex-row sm:justify-end">
                        ...
                        <button
                            type="submit"
                            disabled={isSubmitting || editingTour?.is_locked}
                            className="rounded-2xl bg-gradient-to-r from-primary-700 to-primary-500 px-7 py-3 text-sm font-bold text-white shadow-lg transition hover:-translate-y-0.5 hover:shadow-glow disabled:cursor-not-allowed disabled:opacity-60"
                        >
                            {isSubmitting
                                ? editingTour
                                    ? 'Updating...'
